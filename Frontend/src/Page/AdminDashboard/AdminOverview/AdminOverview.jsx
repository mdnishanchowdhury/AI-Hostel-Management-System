import {LineChart,Line,CartesianGrid,XAxis,YAxis,Tooltip,PieChart,Pie,Cell,BarChart,Bar,Legend,ResponsiveContainer,
} from "recharts";
import {
    FaChartLine,
    FaPizzaSlice,
    ...
    return (
        <div className="p-6 space-y-6 w-full">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-5">
                ...
                <div className="bg-white shadow-md rounded-2xl p-4 flex items-center gap-3">
                    <FaMoneyCheckAlt className="text-red-500 text-2xl" />
                    <div>
                ...
                <div className="bg-white shadow-md rounded-2xl p-4 flex items-center gap-3">
                    ...
                    <div>
                        <h4 className="text-sm text-gray-400">Total Meals</h4>
                        <p className="text-xl font-bold text-gray-800">{summary.totalMeal}</p>
                    </div>
                </div>
